...
def rk4(Ai, Bi, Ci, k1, k2, Dt, t0):
    ...
    while 1:
        ...
        AS1 = Dt * fA(k1, Ai, Bi)
        AS2 = Dt * fA(k1, Ai + 1 / 2 * AS1,Bi + 1 / 2 * AS2)
        AS3 = Dt * fA(k1, Ai + 1 / 2 * AS2,Bi + 1 / 2 * AS3)
        AS4 = Dt * fA(k1, Ai + AS3, Bi + AS4)

        # calculation des quantités intermidiaires pour A
        CS1 = Dt * fA(k1, Ai, Bi)
        CS2 = Dt * fA(k1, Ai + 1 / 2 * AS1,Bi + 1 / 2 * AS2)
        CS3 = Dt * fA(k1, Ai + 1 / 2 * AS2,Bi + 1 / 2 * AS3)
        CS4 = Dt * fA(k1, Ai + AS3, Bi + AS4)
